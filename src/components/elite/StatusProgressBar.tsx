...
export const StatusProgressBar = ({ stats }: StatusProgressBarProps) => {
  ...
  return (
    <div className="elite-progress" aria-label="התקדמות חתימות">
      ...
      <div
        className="elite-progress-seg elite-progress-seg--in-process"
        style={{ width: `${inProcessPct}%` }}
      />
      <div
        className="elite-progress-seg elite-progress-seg--unsigned"
        style={{ width: `${unsignedPct}%` }}
      />
    </div>
  )
}
